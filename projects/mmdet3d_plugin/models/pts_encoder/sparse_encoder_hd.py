...
class SparseEncoderHD(nn.Module):
    ...
    def forward(self, voxel_features, coors, batch_size):
        ...
        input_sp_tensor = mmcv.ops.SparseConvTensor(voxel_features, coors,
                                                  self.sparse_shape,
                                                  batch_size)                                          
    ...
    def make_encoder_layers(self,
        ...
        self.encoder_layers = mmcv.ops.SparseSequential()
        ...
        for i, blocks in enumerate(self.encoder_channels):
            ...
            stage_layers = mmcv.ops.SparseSequential(*blocks_list)
